  ...
  return (
    <header className="menuSuperior">
      <label className="top-hamburguer" data-testid="top-hamburguer" htmlFor="check">
        &#9776;
        <input type="checkbox" className="check" id="check" onChange={ () => menuChecked() } />
      </label>
        ...
        <div className="side-menu-container">
          <nav className="menuLateral">
            <div className="menuButton">
              <Link to="/products" data-testid="side-menu-item-products" className="buttonLateral">
                Produtos
              </Link>
              <Link to="/orders" data-testid="side-menu-item-my-orders" className="buttonLateral">
                Meus Pedidos
              </Link>
              <Link to="/profile" data-testid="side-menu-item-my-profile" className="buttonLateral">
                Meu Perfil
              </Link>
            </div>
